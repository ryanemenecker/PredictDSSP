...
project = 'dssp'
copyright = ("2022, Ryan Emenecker Wusm Holehouse Lab. Project structure based on the "
...
htmlhelp_basename = 'PredictDSSPdoc'
...
latex_documents = [
    (master_doc, 'PredictDSSP.tex', 'dssp Documentation',
     'PredictDSSP', 'manual'),
]
